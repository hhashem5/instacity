...
public class SingleArtActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(SingleArtActivity.this, SearchActivity.class);
        ...
        btnTransfer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(SingleArtActivity.this, ChangeCityActivity.class);
                intent.putExtra("aename", aename);
                startActivity(intent);
            }
        });

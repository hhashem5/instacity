...
//        showPopup();
        ...
        if(intentex.hasExtra("tab")) {
            String tab = intentex.getStringExtra("tab");
            tabint = Integer.parseInt(tab);
//            Toast.makeText(this, "tab"+tabint, Toast.LENGTH_SHORT).show();
        }
...
//        tabLayout.getTabAt(2).setIcon(R.drawable.ic_news);
        ...
        tabLayout.getTabAt(tabint).select();
    }

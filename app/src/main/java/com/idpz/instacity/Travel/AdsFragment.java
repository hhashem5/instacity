...
//        btnAdsReg=(ImageView) view.findViewById(R.id.imgAddAds);
        ...
        adsAdapter= new AdsAdapter(getActivity(),adsModels);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i=jsonArray.length();i>0;i--) {
                                ...
                                area.setPic(getString(R.string.server)+"/assets/images/ads/"+jsonObject.getString("pic"));
